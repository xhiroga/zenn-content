...
アプリケーションに組み込む際などにフレーム単位で動きを制御したい場合、学習データもフレーム単位で制御したいはずです。
...
次の通り、 https://github.com/xhiroga/FramePack-Dev を動かすことでもプレビューすることが可能です。

https://www.youtube.com/watch?v=lGjbCCvgaqk
